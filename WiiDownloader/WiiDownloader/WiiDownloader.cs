...
namespace WiiDownloader
{
    public partial class WiiDownloader_Form : Form
    {
        ...
        string WiiDownloader_version = "3.1";
...
//            WAM_check();
        ...
        {
            MessageBox.Show(
                "[EN] You need to put MAC address for use Wilbrand exploit, only if you haven't Homebrew Channel already installed on your Wii.\n\n"+
                ...
                "WiiDownloader", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }                      
    }
}