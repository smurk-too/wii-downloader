...
namespace WiiDownloader
{
    public partial class WiiDownloader_Form : Form
    {
        ...
        string WiiDownloader_version = "3.0";
        ...
        private bool waitForAppClose(string processToCheck)
        {
            ...
            loop_for_Wait:
                ...
                MySleep(100); // modmmi ha già finito di sicuro tutto, ma ne metto 100 tanto per per.. =P
       ...
       // ButtonValueForStopping
        ...
        private int isAnArchive(string downloadedFile)
        {
            ...
            if (fileExtension.ToLower() == ".zip" || fileExtension == ".7z")
                return 1;
        ...
        private void linkLabelModMii_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("http://modmii.zzl.org/home.html");
        }

        private void linkLabelAppGbatemp_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("http://gbatemp.net/topic/331626-wiidownloader/");
        }

        private void linkLabelAppHackWii_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("http://www.hackwii.it/forum/topic29873.html");
        }

        private void linkLabelAppWiiAttidue_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("http://www.wii-attitude.fr/forum-wiidownloader-f6-vt14453.html");
        }
        ...
        private bool CreateScriptForHack()        {           
            ...
            if ((checkBoxDownloadCFG.Checked == true) || (checkBoxDownloadGX.Checked == true) || (checkBoxDownloadWiiFlow.Checked == true))
            {
                ...
                if (checkBoxDownloadCFG.Checked == true)
                {
                    ...
                    //lines = lines + "Standard, Homebrew - Loader - CFG, - CFG USB Loader - (FORWARDER);";
                }
                ...
                if (checkBoxDownloadGX.Checked == true)
                {
                 ...
                 //   lines = lines + "Standard, Homebrew - Loader - GX, - USB Loader GX - (FORWARDER);";
                }
                ...
                if (checkBoxDownloadWiiFlow.Checked == true)
                {
                  ...
                  //  lines = lines + "Standard, Homebrew - Loader - WiiFlow, - Wiiflow - (FORWARDER);";
                }
        ...
        {
            Process.Start("http://www.91wii.com/thread-63143-1-1.html");
        }        
...
//            WAM_check();
        ...
        private void linkLabelAppChangelog_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("http://code.google.com/p/wii-downloader/wiki/ApplicationChangelog");            
        }

        private void linkLabelDatabaseChangelog_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            Process.Start("http://code.google.com/p/wii-downloader/wiki/DatabaseChangelog");            
        }                              
    }
}